...
// Force Google DNS to resolve MongoDB Atlas SRV records correctly on Windows networks
try {
  dns.setServers(['8.8.8.8', '8.8.4.4']);
} catch (e) {
  console.warn("Vite DNS warning: failed to set custom DNS servers:", e.message);
}
